...
import { 
  ...
  GraduationCap, Sparkles, ArrowRight, Baby
} from 'lucide-react';
      ...
      <div className="min-h-[calc(100vh-4rem)] bg-background">
        ...
        <main className="container mx-auto px-4 py-6 space-y-6 max-w-6xl">
            ...
            <CardContent className="pt-6">
              <div className="mb-4">
                ...
                <p className="text-muted-foreground mt-1">
                  Acompanhe as crianças sob sua orientação e acesse recursos de qualificação profissional.
                </p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card 
              className="group hover:shadow-lg transition-all cursor-pointer border-l-4 border-l-purple-500 hover:border-l-purple-600" 
              onClick={() => navigate('/educare-app/professional/titinauta')}
            >
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  <div className="p-3 rounded-lg bg-purple-100 dark:bg-purple-900/30 text-purple-600 group-hover:bg-purple-200 dark:group-hover:bg-purple-900/50 transition-colors">
                    <Sparkles className="h-6 w-6" />
                  </div>
                  <div className="flex-1">
                    <h3 className="font-semibold mb-1 text-foreground">TitiNauta Especialista</h3>
                    <p className="text-sm text-muted-foreground mb-2">
                      Assistente IA com conhecimento especializado em desenvolvimento infantil
                    </p>
            ...
            >
              <CardContent className="pt-6">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold mb-1 text-foreground">Qualificação Profissional</h3>
                    <p className="text-sm text-muted-foreground mb-2">
                      Materiais, artigos, treinamentos e cursos para sua prática
                    </p>
                  ...
                  {teamChatsLoading ? (
                    ...
                    <Card className="border-dashed">
                      <CardContent className="text-center py-12">
                        ...
                        <p className="text-sm text-muted-foreground max-w-md mx-auto">
                          Você ainda não participa de nenhum grupo de chat. 
                          Aceite os convites na aba "Chat Convites" para começar.
                        </p>
                      </CardContent>
                    </Card>
                  )}
