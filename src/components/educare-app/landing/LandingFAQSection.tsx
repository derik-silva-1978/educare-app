...
const faqItems = [
  ...
  { id: "scientific-base", question: "Qual é a base científica?", answer: "Todo conteúdo é baseado em diretrizes da Organização Mundial da Saúde (OMS), Sociedade Brasileira de Pediatria (SBP) e pesquisas internacionais. Nossa tecnologia proprietária garante que as respostas sejam sempre fundamentadas em evidências científicas atualizadas e validadas por especialistas.", icon: Award },
